...
Source: <https://www.kaggle.com/competitions/deep-past-initiative-machine-translation/writeups/2nd-place-data-centric-akkadian-nmt>
Author: KE WU (`wukeneth`)
Published: 2026-03-24 15:19 UTC
Updated: 2026-03-29 12:53 UTC
Votes: 40
Competition Ranking: 2
Subtitle: Built a three-stage LLM pipeline

## Additional Links

- `text-normalization`: <https://kaggle.com/datasets/wukeneth/text-normalization>
- `submission_word_dict`: <https://kaggle.com/code/wukeneth/submission-word-dict>
- `Akkadian V9 Experi Dataset`: <https://kaggle.com/datasets/wukeneth/akkadian-v9-experi-dataset>
...
**Input**: Corrupt S_meta fragments + OARE API normalized_form, word_index and line_number fields for each word.
